...
INTER_ZONE_SOURCE = "https://fa-azure-network-benchmark.azurewebsites.net/api/data"
...
INTER_ZONE_DISCLAIMER = (
    "Inter-zone latency values are indicative benchmark data based on physical AZ identifiers. "
    "Do NOT remap through logical-to-physical zone mappings. "
    "Validate with in-tenant measurements."
)

INTER_ZONE_METHODOLOGY = "P50 RTT (sum of directional medians, microseconds) between physical AZs"
